...
public class collection3 {
	...
	public static void main(String[] args) {
		...
		employees.add(new Employee(1, "Navya","CSE",45000));
        employees.add(new Employee(4, "Sai","Business",56000));
        employees.add(new Employee(3, "Viswani","IT",43000));
        employees.add(new Employee(2, "Divya","Business",97760));
        employees.add(new Employee(4, "Ammu","IT",78000));
